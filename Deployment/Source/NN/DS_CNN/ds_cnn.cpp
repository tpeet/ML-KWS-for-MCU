 ...
 * Renamed variables and bug fix for:
 * https://github.com/ARM-software/ML-KWS-for-MCU/issues/103
 *
...
const q7_t DS_CNN::final_fc_wt[CONV4_OUT_CH*OUT_DIM]=FINAL_FC_WT;
...
DS_CNN::DS_CNN()
{
    ...
    num_feature_coeffs = NUM_FEATURES_COEFFS;
    num_frames = NUM_FRAMES;
    num_out_classes = OUT_DIM;
    in_dec_bits = FEATURES_DEC_BITS;
}
...
void DS_CNN::run_nn(q7_t* in_data, q7_t* out_data)
{
    ...
    //Average pool
    arm_avepool_q7_HWC_nonsquare (buffer1,CONV4_OUT_X,CONV4_OUT_Y,CONV4_OUT_CH,CONV4_OUT_X,CONV4_OUT_Y,0,0,1,1,1,1,NULL,buffer2, AVG_POOL_OUT_LSHIFT);
    arm_fully_connected_q7(buffer2, final_fc_wt, CONV4_OUT_CH, OUT_DIM, FINAL_FC_BIAS_LSHIFT, FINAL_FC_OUT_RSHIFT, final_fc_bias, out_data, (q15_t*)col_buffer);
}
